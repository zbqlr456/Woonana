  ...
  <div>
    ...
    <ul class="list-group list-group-flush">
      <li class="my-page-list list-group-item">
        <router-link to="/mypage/myposts">내 글</router-link>
      </li>
      <li class="my-page-list list-group-item">
        <router-link to="/mypage/myjoinlog">참여 내역</router-link>
      </li>
      <li class="my-page-list list-group-item">
        <router-link to="/mypage/myworkoutlog">운동 기록</router-link>
      </li>
      <li class="my-page-list list-group-item">
        <router-link to="/mypage/myevallog">평가 페이지</router-link>
      </li>
      <li class="my-page-list list-group-item">
        <router-link to="/mypage/qna">고객 센터</router-link>
      </li>
    </ul>
  </div>
</template>
