<template>
  <div>
    ...
    <ul class="list-group list-group-flush">
      <li class="list-group-item">내 글</li>
      <li class="list-group-item">참여 내역</li>
      <li class="list-group-item">운동 기록</li>
      <li class="list-group-item">평가 페이지</li>
      <li class="list-group-item">고객 센터</li>
    </ul>
  </div>
</template>
<script>
